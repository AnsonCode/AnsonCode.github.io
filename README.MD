...
[![Anson`s Blog](https://github.com/Mogeko/Blog/workflows/Mogeko%60s%20Blog/badge.svg?event=push)](https://ansoncao.me/)
...
使用 Markdown 书写，用 [Hugo](https://gohugo.io/) 生成静态网页，用 `Cloudflare Pages` 部署。
